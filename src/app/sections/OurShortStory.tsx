...
export default function OurShortStory() {
  ...
  return (
    <section ref={sectionRef} className={styles.storySection}>
      ...
      {/* <img ref={imageRef} src="/images/team/Ammar3.png" alt="Ammar" className={styles.storyImage} /> */}
      <img ref={imageRef} src="/images/team/Focused Group Discussion.png" alt="Ammar" className={styles.storyImage} />
